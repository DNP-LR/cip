...
const Header: React.FC<HeaderProps> = ({ progress }) => (
    <div className="bg-[#2F3151] pt-12 pb-24 px-4 md:pb-32 md:px-6 lg:px-12 shadow-xl relative overflow-hidden">
        <div
            className="absolute top-0 right-0 w-96 h-96 bg-[#51536D] opacity-10 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none hidden sm:block"></div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div className="w-full md:w-auto">
                    <div className="flex items-center space-x-3 text-[#A09BAD] mb-4">
                        ...
                        <span className="h-px w-8 bg-[#A09BAD]/50 hidden sm:block"></span>
                        <span className="text-xs font-medium tracking-wider hidden sm:block">ENTRÉE EXPRESS</span>
                    </div>
                ...
                <div
                    className="bg-[#131427] p-5 sm:p-6 w-full md:w-auto rounded-2xl border border-[#51536D]/50 shadow-2xl">
                    <div className="flex items-baseline gap-1"><span
                        className="text-3xl sm:text-4xl font-bold text-white">{progress}</span><span
                        className="text-lg sm:text-xl text-[#A09BAD]">%</span></div>
